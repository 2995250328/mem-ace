...
RUN_ROOT_BASE="${RUN_ROOT_BASE:-/data/xwh/ace_dinov2_lmc/04_evaluation/pmrf_centered_c0_warmup4_sq_bears_20260621_gpu01}"
MEMORY_ROOT="${MEMORY_ROOT:-/data/xwh/ace_dinov2_lmc/04_evaluation/wayspots_ace_fcn_lmc_suite/20260530_181745/memory}"

# Warmup4 test for the two most diagnostic scenes:
...
run_scene() {
  ...
  env \
    ...
    LMC_FUSION_REREAD_WARMUP_MODE=linear \
    LMC_FUSION_REREAD_WARMUP_ITERS=4 \
