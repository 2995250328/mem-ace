...
RUN_ROOT_BASE="${RUN_ROOT_BASE:-/data/xwh/ace_dinov2_lmc/04_evaluation/pmrf_v3_qknorm_layerscale_sq_bears_20260622_gpu01}"
MEMORY_ROOT="${MEMORY_ROOT:-/data/xwh/ace_dinov2_lmc/04_evaluation/wayspots_ace_fcn_lmc_suite/20260530_181745/memory}"

# Two diagnostic scenes used throughout the baseline/PMRF recovery analysis.
SCENE_GPU_PAIRS=(
...
run_scene() {
  ...
  env \
    ...
    LMC_FUSION_REFINEMENT_MODE=centered_reread_qknorm_layerscale \
